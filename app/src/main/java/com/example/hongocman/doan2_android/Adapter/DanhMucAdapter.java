...
public class DanhMucAdapter extends BaseAdapter{
    ...
    public DanhMucAdapter(Activity activity, List<DanhMucApiModel> lst){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.row_danh_muc, null);
    ...
    private class OnItemClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            DanhMuc_Activity sct = (DanhMuc_Activity) activity;
