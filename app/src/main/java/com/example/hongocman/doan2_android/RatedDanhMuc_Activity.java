...
import com.example.hongocman.doan2_android.models.GetRatedDanhMucApiModelTask;

public class RatedDanhMuc_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rated_danh_muc);
        ...
        lvDanhMuc = (ListView)findViewById(R.id.lvRatedDanhMuc);
    ...
    public void onItemClick(int pos) {
        Intent intent = new Intent(RatedDanhMuc_Activity.this, DanhMucChiTietActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            Intent intent = new Intent(RatedDanhMuc_Activity.this, MainActivity.class);
            startActivity(intent);
            //finish();
        }
    ...
    private void getDanhMuc(){
        ...
        if(lvDanhMuc.getAdapter() != null)
            count = lvDanhMuc.getAdapter().getCount();

        String url = APIUrl.API_NEXT_5 + convertRToDanhMuc(loaiDanhMuc) + "/" + count;
        currentOffset += count;
        new GetRatedDanhMucApiModelTask(this, lvDanhMuc).execute(url);
    }

    private int convertRToDanhMuc(long rCode){
